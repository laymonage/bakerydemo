...
class LimitedStreamBlock(StreamBlock):
    ...
    smaller_heading = TextBlock(icon="title", template="blocks/smaller_heading.html")
...
class ContentStreamBlock(StreamBlock):
    ...
    notice = NoticeBlock()
    limited_stream = LimitedStreamBlock(
        help_text="blah blah", label="Limited Stream Field"
    )
...
class SectionBlock(StructBlock):
    ...
    subheadline = TextBlock(
        required=False, help_text="Write a subheadline for this section (optional)."
    )
...
class ComplexBodyBlock(StreamBlock):
    ...
    download = DocumentChooserBlock(
        icon="download", group="Meta stuff"
    )  # , template='blocks/download.html')
